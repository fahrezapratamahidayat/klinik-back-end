...
const getPatientRegistration = async (req, res, next) => {
    try {
        ...
        const patientRegistration = await prisma_1.default.patientRegistration.findMany({
            where: {
                status: { in: ["antrian_kasir", "dalam_antrian_kasir"] },
                registrationDate: {
                    gte: startDate,
...
const updatePatientRegistrationStatus = async (req, res) => {
    try {
        ...
        const updatedRegistration = await prisma_1.default.patientRegistration.update({
            where: { id },
        ...
        const encounter = await prisma_1.default.encounter.findFirst({
        ...
        await prisma_1.default.encounter.update({
